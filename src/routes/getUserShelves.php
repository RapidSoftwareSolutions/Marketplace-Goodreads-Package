...
$app->post('/api/GoodReads/getUserShelves', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'key','userId'=>'user_id'];
    $optionalParams = ['page'=>'page'];
    $bodyParams = [
       'query' => ['key','user_id','page']
    ];
    ...
    $query_str = "https://www.goodreads.com/shelf/list.xml";
