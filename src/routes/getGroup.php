...
$app->post('/api/Goodreads/getGroup', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'key','groupId'=>'groupId'];
    $optionalParams = ['sort'=>'sort','order'=>'order'];
    $bodyParams = [
       'query' => ['key','sort','order']
    ];
    ...
    $query_str = "https://www.goodreads.com/group/show/{$data['groupId']}.xml";
