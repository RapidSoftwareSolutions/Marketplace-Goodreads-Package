...
$app->post('/api/GoodReads/getFriendUpdates', function ($request, $response) {
    ...
    $optionalParams = ['updateType'=>'update','updateFilter'=>'update_filter','maxUpdates'=>'max_updates'];
    $bodyParams = [
       'query' => ['update_filter','update','max_updates']
    ];
    ...
    $query_str = "https://www.goodreads.com/updates/friends.xml";
