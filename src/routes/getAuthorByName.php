...
$app->post('/api/GoodReads/getAuthorByName', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'key','authorName'=>'name'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['key']
    ];
    ...
    $query_str = "https://www.goodreads.com/api/author_url/{$data['name']}";
