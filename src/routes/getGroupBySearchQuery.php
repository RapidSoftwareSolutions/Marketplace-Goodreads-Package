...
$app->post('/api/GoodReads/getGroupBySearchQuery', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'key','searchQuery'=>'q'];
    ...
    $query_str = "https://www.goodreads.com/group/search.xml";
