...
$app->post('/api/Goodreads/addBooksToMultipleShelves', function ($request, $response) {
    ...
    $data['bookids'] = \Models\Params::toString($data['bookids'], ',');
    $data['shelves'] = \Models\Params::toString($data['shelves'], ',');


    $query_str = "https://www.goodreads.com/shelf/add_books_to_shelves.xml";
