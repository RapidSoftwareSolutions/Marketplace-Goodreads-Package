...
$app->post('/api/GoodReads/getCommentsList', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessTokenSecret','type','resourceId']);
    ...
    $requiredParams = ['apiKey'=>'key','apiSecret'=>'secret','accessToken'=>'token','accessTokenSecret'=>'tokenSecret','type'=>'type','resourceId'=>'id'];
