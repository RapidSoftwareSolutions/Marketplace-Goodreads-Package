...
$app->post('/api/GoodReads/getReview', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'key','apiSecret'=>'secret','accessToken'=>'token','accessTokenSecret'=>'tokenSecret','reviewId'=>'id'];
    ...
    $query_str = "https://www.goodreads.com/review/show.xml";
