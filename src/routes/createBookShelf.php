...
$app->post('/api/Goodreads/createBookShelf', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessTokenSecret','shelfName']);
    ...
    $requiredParams = ['apiKey'=>'key','apiSecret'=>'secret','accessToken'=>'token','accessTokenSecret'=>'tokenSecret','shelfName'=>'user_shelf[name]'];
    $optionalParams = ['exclusiveFlag'=>'user_shelf[exclusive_flag]','sortableFlag'=>'user_shelf[sortable_flag]','featured'=>'user_shelf[featured]'];
    $bodyParams = [
